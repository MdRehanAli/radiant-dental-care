export default function TeamDoctors() {
  const doctors = [
    ...
    },
    {
      ...
      specialization: 'He is known for his calming chairside manner, making even the most complex procedures feel routine and manageable. Dr. Alpine is a leading advocate for the use of digital guided surgery to reduce recovery times.',
